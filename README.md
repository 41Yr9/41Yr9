...
*   **使用技術**: Arduino（C/C++）によるロボット制御
*   **担当**: ロボットの設計・プログラミング・チームリーダー
*   全国大会に向けた準備は本当にきつく、チーム4人で何度も壁にぶつかりながら乗り越えた経験は、今のチーム開発にも活きています。
...
**Esports Designer / Graphic Design — Fortnite シーン**

高校生時代はFortniteのEsportsシーンで活動。自身もセミプロレベル（**大会アジア50〜500位**）の実力を持ちながら、チームの専属デザイナーとしてブランディングに貢献しました。

*   **制作実績**: **50件以上**のデザインをすべて無償で制作。ヘッダー画像、大会用クリエイティブなどを手掛けました。
*   **注目の実績**: **Crazy Raccoon (CR) 所属プロゲーマーのヘッダーデザイン**を担当。
...
大学入学後、アパレルブランド「**TIER**」を立ち上げ、約半年間運営しました。
